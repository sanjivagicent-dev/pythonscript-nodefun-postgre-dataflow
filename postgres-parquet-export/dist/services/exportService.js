...
export const exportData = async (prisma) => {
    ...
    while (currentStart.isBefore(endDate)) {
        ...
        while (true) {
            ...
            logger.info({ batchSize: batch.length, totalRows }, 'Batch processed');
        }
        await writer.close();
        ...
        logger.info({ source: filePath, destination: destinationPath }, 'File moved');
